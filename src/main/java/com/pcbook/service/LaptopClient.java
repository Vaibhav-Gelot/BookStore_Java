...
public class LaptopClient {
 ...
 private final LaptopServiceGrpc.LaptopServiceBlockingStub laptopServiceBlockingStub;
 ...
 public LaptopClient(String host , int port){
  ...
  laptopServiceBlockingStub= LaptopServiceGrpc.newBlockingStub(managedChannel);
  asyncStub = LaptopServiceGrpc.newStub(managedChannel);
 }
 ...
 public void createLaptop(Laptop laptop){
     ...
     CreateLaptopResponse createLaptopResponse=CreateLaptopResponse.getDefaultInstance();
     try{
         createLaptopResponse=laptopServiceBlockingStub.withDeadlineAfter(5, TimeUnit.SECONDS).createLaptop(createLaptopRequest);
    ...
    logger.info("Laptop created with ID :" + createLaptopResponse.getId());
 }
 public void searchLaptop(Filter filter) {
        ...
        ArrayList<SearchLaptopResponse> responseArrayList=new ArrayList<>();
  try{

      Iterator<SearchLaptopResponse> responseIterator= laptopServiceBlockingStub.withDeadlineAfter(5,TimeUnit.SECONDS).searchLaptop(request);
      while(responseIterator.hasNext()){
          SearchLaptopResponse laptopResponse=responseIterator.next();
          Laptop laptop = laptopResponse.getLaptop();
