...
public class Generator {
   ...
   public Laptop NewLaptop(){
        ...
        return Laptop.newBuilder()
                ...
                .setUpdatedAt(timeStampNow()).build();
   }
   ...
   private String randomCPUBrand(){
    ...
    private Keyboard.Layout randomKeyboarLayout() {
